        ...
        <div className="min-h-screen hero-bg grid-bg flex items-center justify-center px-4">
            <div className="w-full max-w-md">
                <div className="glass-card p-8" style={{ border: '1px solid rgba(91,120,245,0.2)' }}>
                    ...
                    <p className="text-center text-sm mb-8" style={{ color: 'var(--text-secondary)' }}>Sign in to your TruthLens account</p>
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input name="password" type={showPass ? 'text' : 'password'} value={form.password} onChange={handle} className="input-glass pr-10" placeholder="••••••••" required />
